...
(1002,'/admin/annual/index.co','ANALYZE.ANNUAL','年报处理',10,0,''),
	...
	(10023,'/admin/annual/querypdf.co','ANALYZE.ANNUAL.QUERYPDF','查询报表文件',1002,2,''),
(1003,'/admin/analyser/salevertical.co','ANALYZE.ANALYSER.SALESVERTICAL','销售分析',10,0,''),
...
(1004,'/admin/analyser/securityvertical.co','ANALYZE.ANALYSER.SECURITYVERTICAL','证券分析',10,0,''),
...
(1007,'/admin/annual/securities.co','ANALYZE.ANNUAL.SECURITIES','证券管理',10,0,''),
	(10071,'/admin/annual/editsecurities.co','ANALYZE.ANNUAL.EDITSECURITIES','证券编辑',1007,0,''),
